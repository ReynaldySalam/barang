...
class Jenis extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->admin->check_jenis_exists($input['nama_jenis'])) {
                set_pesan('Data jenis sudah ada.', false);
                redirect('jenis/add');
            } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $input = $this->input->post(null, true);
            $current_jenis = $this->admin->get('jenis', ['id_jenis' => $id]);
            if ($input['nama_jenis'] != $current_jenis['nama_jenis'] && $this->admin->check_jenis_exists($input['nama_jenis'])) {
                set_pesan('Data jenis sudah ada.', false);
                redirect('jenis/edit/' . $id);
            } else {
