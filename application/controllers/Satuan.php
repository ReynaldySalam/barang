...
class Satuan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->admin->check_satuan_exists($input['nama_satuan'])) {
                set_pesan('Data satuan sudah ada.', false);
                redirect('satuan/add');
            } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $input = $this->input->post(null, true);
            $current_satuan = $this->admin->get('satuan', ['id_satuan' => $id]);
            if ($input['nama_satuan'] != $current_satuan['nama_satuan'] && $this->admin->check_satuan_exists($input['nama_satuan'])) {
                set_pesan('Data satuan sudah ada.', false);
