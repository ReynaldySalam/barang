...
class Barang extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $input = $this->input->post(null, true);
             if ($this->admin->check_barang_exists($input['nama_barang'])) {
                set_pesan('Data barang sudah ada.', false);
                redirect('barang/add');
            } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $input = $this->input->post(null, true);
            if ($input['nama_barang'] != $current_barang['nama_barang'] && $this->admin->check_barang_exists($input['nama_barang'])) {
                set_pesan('Data barang sudah ada.', false);
